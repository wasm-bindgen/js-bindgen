(module $basic-2be9113d34cbacad.wasm
  ...
  (func $__wasm_init_memory (;3;) (type 2)
    i32.const 1048596
    i32.const 0
    i32.const 20
    memory.fill
      ...
      block ;; label = @2
        block ;; label = @3
          ...
          block ;; label = @4
            ...
            select
            local.tee 4
            call $_ZN5alloc7raw_vec20RawVecInner$LT$A$GT$11finish_grow17h8a3382b4d7970919E
            local.get 0
            i32.load offset=4
            br_if 2 (;@2;)
            i32.const 0
  ...
  (func $_ZN5alloc7raw_vec20RawVecInner$LT$A$GT$11finish_grow17h8a3382b4d7970919E (;5;) (type 3) (param i32 i32 i32 i32)
  ...
  (func $_ZN4core6result13unwrap_failed17hd3da41c67c4586a8E (;6;) (type 4) (param i32)
  ...
  (func $js_sys.externref.next (;8;) (type 5) (result i32)
    (local i32 i32)
    block ;; label = @1
      block ;; label = @2
        i32.const 0
  ...
  (func $js_sys.string_decode (;9;) (type 6) (param i32 i32) (result i32)
    local.get 0
    local.get 1
    call $js_sys.import.string_decode
    call $js_sys.externref.insert
  )
  (func $js_sys.externref.grow (;10;) (type 7) (param i32) (result i32)
    ref.null extern
    local.get 0
    table.grow 0
  )
  (func $js_sys.externref.insert (;11;) (type 8) (param externref) (result i32)
    (local i32)
  ...
  (func $js_sys.externref.get (;12;) (type 9) (param i32) (result externref)
    local.get 0
    table.get 0
  )
  (func $js_sys.externref.remove (;13;) (type 4) (param i32)
    local.get 0
    ref.null extern
    table.set 0
  )
  (func $web_sys.console.log (;14;) (type 4) (param i32)
    local.get 0
    call $js_sys.externref.get
    call $web_sys.import.console.log
  )
  (func $web_sys.console.log0 (;15;) (type 2)
