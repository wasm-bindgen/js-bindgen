...
impl<T> JsArray<T> {
    pub fn length(self: &JsArray<T>) -> u32 {
        ...
        js_bindgen::import_js! {
            ...
            r#macro::select("", "self", & [< & JsValue as Input > ::JS_CONV_POST]),
            interpolate r#macro::select("", < & JsValue as Input > ::JS_CONV_POST, & [< &
...
pub(super) fn array_js_value_encode(
    ...
    js_bindgen::import_js! {
        module = "js_sys", name = "array_js_value_encode", required_embeds =
        ["array.js_value.encode", < * const JsValue as Input > ::JS_CONV_EMBED, <
        PtrLength as Input > ::JS_CONV_EMBED], "{}{}{}{}{}{}{}{}{}{}{}{}", interpolate
...
pub(super) fn array_js_value_decode(
    ...
    js_bindgen::import_js! {
        module = "js_sys", name = "array_js_value_decode", required_embeds =
        ["array.js_value.decode", < & JsArray as Input > ::JS_CONV_EMBED, < * mut JsValue
        as Input > ::JS_CONV_EMBED, < PtrLength as Input > ::JS_CONV_EMBED, < * const i32
...
pub(super) fn array_u32_encode(array: *const u32, len: PtrLength) -> JsArray<u32> {
    ...
    js_bindgen::import_js! {
        module = "js_sys", name = "array_u32_encode", required_embeds =
        ["array.u32.encode", < * const u32 as Input > ::JS_CONV_EMBED, < PtrLength as
...
pub(super) fn array_u32_decode(
    ...
    js_bindgen::import_js! {
        module = "js_sys", name = "array_u32_decode", required_embeds =
        ["array.u32.decode", < & JsArray < u32 > as Input > ::JS_CONV_EMBED, < * mut u32
        as Input > ::JS_CONV_EMBED, < PtrLength as Input > ::JS_CONV_EMBED],
        "{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}{}", interpolate
